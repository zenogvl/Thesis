...
#Read data
dataIn <- haven::read_sav("Data/FromOriginalPapers/Brans_2013_S1_raw.sav")
...
varSelect <- c("ppid", "day_new", "beep", "angry" , "depr", "anx", "stress", "relax", "happy")
newVarLabels <- c("ID", "day", "beep","Angry" , "Depressed", "Anxiety", "Stressed", "Relaxed", "Happy")
...
#Write data as csv
write.csv(data, file = "Data/Clean/Brans_2013_ds1.csv")


#Vector of emotions in study
Emotions <- c("Angry" , "Depressed", "Anxiety", "Stressed", "Relaxed", "Happy")

#createMetaDataFile(vars = Emotions, obsIDvars = newVarLabels[1:3], scale = "1-6", 
#                   author = "Brans", year = "2013_DS1", data = data)
